...
const About = () => {
  return (
    <section className="about-section relative bg-black flex items-center justify-center px-4 min-h-screen overflow-hidden">
      {/* About Content */}
      <div className="about-content flex flex-col lg:flex-row items-center justify-center lg:space-x-8 w-full max-w-6xl relative z-10 ">
        ...
        <div className="about-image w-full lg:w-1/2 flex justify-center lg:mb-2 sm:mb-32 ">
          <img
